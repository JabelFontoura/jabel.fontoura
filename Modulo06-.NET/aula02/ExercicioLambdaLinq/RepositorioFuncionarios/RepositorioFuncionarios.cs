...
namespace Repositorio
{
    public class RepositorioFuncionarios
    {
        ...
        {
            return Funcionarios.Where(funcionario => CaseContains(funcionario.Nome, nome, StringComparison.CurrentCultureIgnoreCase)).ToList();
        }        
        ...
        {
            return Funcionarios.Where(f => turno.Equals(null) ? true : f.TurnoTrabalho.Equals(turno)).Select(f => f.Cargo.Salario).Average();
        }
