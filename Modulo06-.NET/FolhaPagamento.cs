...
namespace Exercicio3
{
    public class FolhaPagamento : IFolhaPagamento
    {
        ...
        {
            double valorHora = Math.Round(salarioBase / horasCategoria, 777);
            ...
            return new Demonstrativo(salarioBase, horasCategoria, HorasExtras, HorasDescontadas, TotalProventos,
