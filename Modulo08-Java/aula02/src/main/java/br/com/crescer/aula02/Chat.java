...
import br.com.crescer.exercicios.StringUtils;
...
public class Chat {
    ...
    private static final StringUtils STRING_UTILS = new MeuStringUtils();
    ...
    public static void main(String[] args) {
        if (args.length < 2) {
            args = new String[]{"\\\\10.0.100.102\\cwitmp\\carloshenrique\\aula.txt", "@jabel"};
        }
